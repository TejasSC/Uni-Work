...
int nStructs = 1;		/* how many structures to keep accessing - defines working set */
...
struct entry {			/* this is the data structure we access */
  ...
  int padding[18];		/* and some extra variables */
};
...
main(int argc, char **argv) {
  ...
  for (nStructs = 1; nStructs <= 1000000; nStructs = nStructs*2) {
